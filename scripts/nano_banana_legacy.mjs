...
if (!prompt || !outputPath) {
    console.error("Uso: node nano_banana_legacy.mjs '<prompt>' <caminho_da_imagem.jpg>");
    process.exit(1);
}

async function generateImage() {
    console.log(`Gerando imagem (Modelo 3.0) para: "${prompt}"...`);
    try {
        // Tentando o endpoint da Imagen 3.0 que costuma estar disponível em chaves de teste
